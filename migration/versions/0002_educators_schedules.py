...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ['edit_by'], ['users.user_id'], name=op.f(
                'fk_educators_schedules_edit_by_users'
            )
        ),
    ...
    op.create_index(
        op.f('ix_educators_schedules_date'), 'educators_schedules', ['date'],
        unique=True
    )
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        op.f('ix_educators_schedules_date'), table_name='educators_schedules'
    )
    op.drop_constraint(
        op.f('uq_educators_schedules_id'), 'educators_schedules',
        type_='unique'
    )
