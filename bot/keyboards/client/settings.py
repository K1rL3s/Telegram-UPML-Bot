...
from bot.utils.consts import UserCallback, GRADES
...
choose_grade_keyboard = (
    ...
    .add(
        *[
        ...
        InlineKeyboardButton(
            text="⏪Настройки", callback_data=UserCallback.OPEN_SETTINGS
        ),
        InlineKeyboardButton(
            text="❓Сбросить класс", callback_data=UserCallback.CHANGE_GRADE_TO_ + "None"
        ),
    )
    .adjust(3, 3, 2)
    .as_markup()
