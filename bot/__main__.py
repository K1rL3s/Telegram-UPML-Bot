...
4. Сделать лог callback'ов и сообщений на RequestMiddleware,
чтобы логгировало всё, а не только попавшееся в обработку.
5. Сделать загрузку картинок/файлов на меню с элективами.
6. Проверить и исправить, что слои database – logic – view сильно не перемешаны :(.
7. Переписать код в bot/handlers/admin/admin_lessons.py :(
"""
